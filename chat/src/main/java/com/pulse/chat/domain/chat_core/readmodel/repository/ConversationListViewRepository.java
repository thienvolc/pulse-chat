package com.pulse.chat.domain.chat_core.readmodel.repository;
...
public interface ConversationListViewRepository
        extends JpaRepository<ConversationListViewEntity, UUID> {

    Page<ConversationListViewEntity> findByUserIdOrderByLastMessageAtDescCreatedAtDesc(
            UUID userId, Pageable pageable);

    Optional<ConversationListViewEntity> findByUserIdAndConversationId(UUID userId,
                                                                       UUID conversationId);
    ...
    Instant findLatestProjectedMessageAt();
}
